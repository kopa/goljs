...
(function(jasmine, console) {
  ...
  proto.reportSpecResults = function(spec) {
    ...
    if (spec.results().passed()) {
      this.passed_specs++;
      this.log(this.getResultText(spec), "green");
      return;
    }

    this.log(this.getResultText(spec), "red");
  ...
  proto.getResultText = function(spec) {
    return spec.suite.description + " : " + spec.description;
  };
